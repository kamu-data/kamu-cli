...
ALTER TABLE flow_configuration_events ADD COLUMN flow_type VARCHAR(100);
ALTER TABLE flow_configuration_events ADD COLUMN scope_data JSONB;
...
CREATE INDEX idx_flow_configuration_events_dataset_scope
    ON flow_configuration_events (flow_type, (scope_data->>'dataset_id'))
...
DROP INDEX IF EXISTS idx_flow_configuration_events_dataset_flow_key;
DROP INDEX IF EXISTS idx_flow_configuration_events_system_flow_key;
