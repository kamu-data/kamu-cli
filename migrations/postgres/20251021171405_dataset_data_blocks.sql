...
CREATE TABLE dataset_data_blocks (
    ...
    block_hash_hex     TEXT GENERATED ALWAYS AS (('f1620' || encode(block_hash_bin, 'hex'))) STORED, -- TODO: VIRTUAL after Postgres 18
...
ALTER TABLE dataset_references
    ADD COLUMN block_hash_hex TEXT GENERATED ALWAYS AS (('f1620' || encode(block_hash_bin, 'hex'))) STORED; -- TODO: VIRTUAL after Postgres 18
