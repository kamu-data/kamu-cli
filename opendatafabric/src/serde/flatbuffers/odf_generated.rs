...
impl flatbuffers::Verifiable for EventTimeSourceFromPath<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>(&"timestamp_format", Self::VT_TIMESTAMP_FORMAT, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a> FetchStepUrl<'a> {
  ...
  pub fn event_time_as_event_time_source_from_metadata(&self) -> Option<EventTimeSourceFromMetadata<'a>> {
    if self.event_time_type() == EventTimeSource::EventTimeSourceFromMetadata {
      self.event_time().map(EventTimeSourceFromMetadata::init_from_table)
    } else {
      None
    }
  }
  ...
  pub fn event_time_as_event_time_source_from_path(&self) -> Option<EventTimeSourceFromPath<'a>> {
    if self.event_time_type() == EventTimeSource::EventTimeSourceFromPath {
      self.event_time().map(EventTimeSourceFromPath::init_from_table)
    } else {
      None
    }
  }
      ...
      match self.event_time_type() {
        EventTimeSource::EventTimeSourceFromMetadata => {
          if let Some(x) = self.event_time_as_event_time_source_from_metadata() {
            ...
            ds.field("event_time", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        },
        EventTimeSource::EventTimeSourceFromPath => {
      ...
      match self.cache_type() {
        SourceCaching::SourceCachingForever => {
          if let Some(x) = self.cache_as_source_caching_forever() {
            ...
            ds.field("cache", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        },
        _ => {
          let x: Option<()> = None;
...
impl<'a> FetchStepFilesGlob<'a> {
  ...
  pub fn order(&self) -> Option<SourceOrdering> {
    self._tab.get::<SourceOrdering>(FetchStepFilesGlob::VT_ORDER, None)
  }
  #[inline]
  #[allow(non_snake_case)]
  pub fn event_time_as_event_time_source_from_metadata(&self) -> Option<EventTimeSourceFromMetadata<'a>> {
...
impl<'a: 'b, 'b> FetchStepFilesGlobBuilder<'a, 'b> {
  ...
  pub fn add_order(&mut self, order: SourceOrdering) {
    self.fbb_.push_slot_always::<SourceOrdering>(FetchStepFilesGlob::VT_ORDER, order);
  }
  #[inline]
...
impl<'a> PrepStepDecompress<'a> {
  ...
  pub fn format(&self) -> CompressionFormat {
    self._tab.get::<CompressionFormat>(PrepStepDecompress::VT_FORMAT, Some(CompressionFormat::Gzip)).unwrap()
  }
  #[inline]
...
impl flatbuffers::Verifiable for PrepStepDecompress<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>(&"sub_path", Self::VT_SUB_PATH, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b> PrepStepDecompressBuilder<'a, 'b> {
  ...
  pub fn add_format(&mut self, format: CompressionFormat) {
    self.fbb_.push_slot::<CompressionFormat>(PrepStepDecompress::VT_FORMAT, format, CompressionFormat::Gzip);
  }
  #[inline]
...
impl<'a> PrepStepPipe<'a> {
  ...
  pub fn command(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(PrepStepPipe::VT_COMMAND, None)
  }
}
...
impl<'a> ReadStepCsv<'a> {
  ...
  pub fn schema(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(ReadStepCsv::VT_SCHEMA, None)
  }
  #[inline]
  ...
  pub fn ignore_leading_white_space(&self) -> Option<bool> {
    self._tab.get::<bool>(ReadStepCsv::VT_IGNORE_LEADING_WHITE_SPACE, None)
  }
  #[inline]
  pub fn ignore_trailing_white_space(&self) -> Option<bool> {
    self._tab.get::<bool>(ReadStepCsv::VT_IGNORE_TRAILING_WHITE_SPACE, None)
  }
  #[inline]
...
impl flatbuffers::Verifiable for ReadStepCsv<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<&'_ str>>>>(&"schema", Self::VT_SCHEMA, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>(&"separator", Self::VT_SEPARATOR, false)?
     ...
     .visit_field::<bool>(&"ignore_leading_white_space", Self::VT_IGNORE_LEADING_WHITE_SPACE, false)?
     .visit_field::<bool>(&"ignore_trailing_white_space", Self::VT_IGNORE_TRAILING_WHITE_SPACE, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>(&"null_value", Self::VT_NULL_VALUE, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>(&"empty_value", Self::VT_EMPTY_VALUE, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>(&"nan_value", Self::VT_NAN_VALUE, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>(&"positive_inf", Self::VT_POSITIVE_INF, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>(&"negative_inf", Self::VT_NEGATIVE_INF, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>(&"date_format", Self::VT_DATE_FORMAT, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>(&"timestamp_format", Self::VT_TIMESTAMP_FORMAT, false)?
...
impl<'a: 'b, 'b> ReadStepCsvBuilder<'a, 'b> {
  ...
  pub fn add_header(&mut self, header: bool) {
    self.fbb_.push_slot_always::<bool>(ReadStepCsv::VT_HEADER, header);
  }
  #[inline]
  pub fn add_enforce_schema(&mut self, enforce_schema: bool) {
    self.fbb_.push_slot_always::<bool>(ReadStepCsv::VT_ENFORCE_SCHEMA, enforce_schema);
  }
  #[inline]
  pub fn add_infer_schema(&mut self, infer_schema: bool) {
    self.fbb_.push_slot_always::<bool>(ReadStepCsv::VT_INFER_SCHEMA, infer_schema);
  }
  #[inline]
  pub fn add_ignore_leading_white_space(&mut self, ignore_leading_white_space: bool) {
    self.fbb_.push_slot_always::<bool>(ReadStepCsv::VT_IGNORE_LEADING_WHITE_SPACE, ignore_leading_white_space);
  }
  #[inline]
  pub fn add_ignore_trailing_white_space(&mut self, ignore_trailing_white_space: bool) {
    self.fbb_.push_slot_always::<bool>(ReadStepCsv::VT_IGNORE_TRAILING_WHITE_SPACE, ignore_trailing_white_space);
  }
  #[inline]
  ...
  pub fn add_multi_line(&mut self, multi_line: bool) {
    self.fbb_.push_slot_always::<bool>(ReadStepCsv::VT_MULTI_LINE, multi_line);
  }
  #[inline]
...
impl std::fmt::Debug for ReadStepCsv<'_> {
  fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
    let mut ds = f.debug_struct("ReadStepCsv");
      ...
      ds.field("ignore_leading_white_space", &self.ignore_leading_white_space());
      ds.field("ignore_trailing_white_space", &self.ignore_trailing_white_space());
...
impl<'a> ReadStepJsonLines<'a> {
  ...
  #[inline]
  pub fn schema(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(ReadStepJsonLines::VT_SCHEMA, None)
  }
  #[inline]
  pub fn date_format(&self) -> Option<&'a str> {
  ...
  #[inline]
  pub fn multi_line(&self) -> Option<bool> {
    self._tab.get::<bool>(ReadStepJsonLines::VT_MULTI_LINE, None)
  }
  #[inline]
  pub fn primitives_as_string(&self) -> Option<bool> {
    self._tab.get::<bool>(ReadStepJsonLines::VT_PRIMITIVES_AS_STRING, None)
  }
  #[inline]
  pub fn timestamp_format(&self) -> Option<&'a str> {
...
impl<'a: 'b, 'b> ReadStepJsonLinesBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_multi_line(&mut self, multi_line: bool) {
    self.fbb_.push_slot_always::<bool>(ReadStepJsonLines::VT_MULTI_LINE, multi_line);
  }
  #[inline]
  pub fn add_primitives_as_string(&mut self, primitives_as_string: bool) {
    self.fbb_.push_slot_always::<bool>(ReadStepJsonLines::VT_PRIMITIVES_AS_STRING, primitives_as_string);
  }
  #[inline]
  pub fn add_timestamp_format(&mut self, timestamp_format: flatbuffers::WIPOffset<&'b  str>) {
...
impl<'a> ReadStepGeoJson<'a> {
  ...
  #[inline]
  pub fn schema(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(ReadStepGeoJson::VT_SCHEMA, None)
  }
}
...
impl<'a> ReadStepEsriShapefile<'a> {
  ...
  #[inline]
  pub fn schema(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(ReadStepEsriShapefile::VT_SCHEMA, None)
  }
  #[inline]
  pub fn sub_path(&self) -> Option<&'a str> {
...
impl<'a> TransformSql<'a> {
  ...
  pub fn queries(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<SqlQueryStep<'a>>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<SqlQueryStep>>>>(TransformSql::VT_QUERIES, None)
  }
  #[inline]
  pub fn temporal_tables(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<TemporalTable<'a>>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<TemporalTable>>>>(TransformSql::VT_TEMPORAL_TABLES, None)
  }
}
...
impl flatbuffers::Verifiable for TransformSql<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<SqlQueryStep>>>>(&"queries", Self::VT_QUERIES, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<TemporalTable>>>>(&"temporal_tables", Self::VT_TEMPORAL_TABLES, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a> MergeStrategyLedger<'a> {
  ...
  pub fn primary_key(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(MergeStrategyLedger::VT_PRIMARY_KEY, None)
  }
}
...
impl flatbuffers::Verifiable for MergeStrategyLedger<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<&'_ str>>>>(&"primary_key", Self::VT_PRIMARY_KEY, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a> MergeStrategySnapshot<'a> {
  ...
  #[inline]
  pub fn primary_key(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(MergeStrategySnapshot::VT_PRIMARY_KEY, None)
  }
  #[inline]
  pub fn compare_columns(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(MergeStrategySnapshot::VT_COMPARE_COLUMNS, None)
  }
  #[inline]
...
impl flatbuffers::Verifiable for MergeStrategySnapshot<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<&'_ str>>>>(&"primary_key", Self::VT_PRIMARY_KEY, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<&'_ str>>>>(&"compare_columns", Self::VT_COMPARE_COLUMNS, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>(&"observation_column", Self::VT_OBSERVATION_COLUMN, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>(&"obsv_added", Self::VT_OBSV_ADDED, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>(&"obsv_changed", Self::VT_OBSV_CHANGED, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>(&"obsv_removed", Self::VT_OBSV_REMOVED, false)?
     .finish();
    Ok(())
  }
}
...
impl flatbuffers::Verifiable for PrepStepWrapper<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_union::<PrepStep, _>(&"value_type", Self::VT_VALUE_TYPE, &"value", Self::VT_VALUE, false, |key, v, pos| {
        match key {
          PrepStep::PrepStepDecompress => v.verify_union_variant::<flatbuffers::ForwardsUOffset<PrepStepDecompress>>("PrepStep::PrepStepDecompress", pos),
          PrepStep::PrepStepPipe => v.verify_union_variant::<flatbuffers::ForwardsUOffset<PrepStepPipe>>("PrepStep::PrepStepPipe", pos),
          _ => Ok(()),
        }
     })?
     .finish();
...
impl<'a> DatasetSourceRoot<'a> {
  ...
  pub fn prepare(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<PrepStepWrapper<'a>>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<PrepStepWrapper>>>>(DatasetSourceRoot::VT_PREPARE, None)
  }
  #[inline]
      ...
      match self.fetch_type() {
        FetchStep::FetchStepUrl => {
          if let Some(x) = self.fetch_as_fetch_step_url() {
            ...
            ds.field("fetch", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        },
        FetchStep::FetchStepFilesGlob => {
      ...
      match self.read_type() {
        ReadStep::ReadStepCsv => {
          if let Some(x) = self.read_as_read_step_csv() {
            ...
            ds.field("read", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        },
        ReadStep::ReadStepJsonLines => {
      ...
      match self.preprocess_type() {
        Transform::TransformSql => {
          if let Some(x) = self.preprocess_as_transform_sql() {
            ...
            ds.field("preprocess", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        },
        _ => {
          let x: Option<()> = None;
      ...
      match self.merge_type() {
        MergeStrategy::MergeStrategyAppend => {
          if let Some(x) = self.merge_as_merge_strategy_append() {
            ...
            ds.field("merge", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        },
        MergeStrategy::MergeStrategyLedger => {
...
impl<'a> DatasetSourceDerivative<'a> {
  ...
  pub fn inputs(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(DatasetSourceDerivative::VT_INPUTS, None)
  }
  #[inline]
...
impl flatbuffers::Verifiable for DatasetSourceDerivative<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_union::<Transform, _>(&"transform_type", Self::VT_TRANSFORM_TYPE, &"transform", Self::VT_TRANSFORM, false, |key, v, pos| {
        match key {
          Transform::TransformSql => v.verify_union_variant::<flatbuffers::ForwardsUOffset<TransformSql>>("Transform::TransformSql", pos),
          _ => Ok(()),
        }
...
impl flatbuffers::Verifiable for DatasetVocabulary<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>(&"system_time_column", Self::VT_SYSTEM_TIME_COLUMN, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>(&"event_time_column", Self::VT_EVENT_TIME_COLUMN, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a> TemporalTable<'a> {
  ...
  #[inline]
  pub fn primary_key(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(TemporalTable::VT_PRIMARY_KEY, None)
  }
}
...
impl<'a> DatasetSnapshot<'a> {
  ...
  pub fn vocab(&self) -> Option<DatasetVocabulary<'a>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<DatasetVocabulary>>(DatasetSnapshot::VT_VOCAB, None)
  }
  #[inline]
  #[allow(non_snake_case)]
...
impl<'a> DataSlice<'a> {
  ...
  pub fn num_records(&self) -> i64 {
    self._tab.get::<i64>(DataSlice::VT_NUM_RECORDS, Some(0)).unwrap()
  }
}
...
impl<'a: 'b, 'b> DataSliceBuilder<'a, 'b> {
  ...
  pub fn add_num_records(&mut self, num_records: i64) {
    self.fbb_.push_slot::<i64>(DataSlice::VT_NUM_RECORDS, num_records, 0);
  }
  #[inline]
...
impl<'a> MetadataBlock<'a> {
  ...
  pub fn output_slice(&self) -> Option<DataSlice<'a>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<DataSlice>>(MetadataBlock::VT_OUTPUT_SLICE, None)
  }
  #[inline]
  ...
  pub fn input_slices(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<DataSlice<'a>>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<DataSlice>>>>(MetadataBlock::VT_INPUT_SLICES, None)
  }
  #[inline]
  pub fn source_type(&self) -> DatasetSource {
  ...
  #[inline]
  pub fn vocab(&self) -> Option<DatasetVocabulary<'a>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<DatasetVocabulary>>(MetadataBlock::VT_VOCAB, None)
  }
  #[inline]
  #[allow(non_snake_case)]
  pub fn source_as_dataset_source_root(&self) -> Option<DatasetSourceRoot<'a>> {
