...
pub const SPARK: &str = "docker.io/kamudata/engine-spark:0.12.0-spark_3.1.2";
pub const LIVY: &str = SPARK;
pub const FLINK: &str = "docker.io/kamudata/engine-flink:0.10.0-flink_1.13.1-scala_2.12-java8";
