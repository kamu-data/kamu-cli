...
use crate::resources::{
    ResourceContextSummaryView,
    ResourceContextTypeView,
...
#[dill::component(pub)]
#[dill::interface(dyn ResourceSummaryService)]
pub struct ResourceSummaryServiceImpl {
...
impl ResourceSummaryService for ResourceSummaryServiceImpl {
    async fn summary(
        &self,
...
impl ResourceSummaryServiceImpl {
