...
pub struct PostgresTaskSystemEventStore {
    transaction: TransactionRefT<sqlx::Postgres>,
}

#[component(pub)]
#[interface(dyn TaskSystemEventStore)]
impl PostgresTaskSystemEventStore {
...
impl EventStore<TaskState> for PostgresTaskSystemEventStore {
...
#[async_trait::async_trait]
impl TaskSystemEventStore for PostgresTaskSystemEventStore {
