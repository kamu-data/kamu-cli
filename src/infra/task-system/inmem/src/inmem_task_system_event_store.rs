...
pub struct InMemoryTaskSystemEventStore {
...
#[scope(Singleton)]
impl InMemoryTaskSystemEventStore {
    pub fn new() -> Self {
        Self {
...
impl EventStore<TaskState> for InMemoryTaskSystemEventStore {
...
#[async_trait::async_trait]
impl TaskSystemEventStore for InMemoryTaskSystemEventStore {
