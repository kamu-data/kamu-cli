...
async fn test_upsert_merge<L, I, E, S>(ledger: L, input: I, expected: E)
where
    ...
    S: Into<String>,
{
    ...
    let strat = MergeStrategyUpsertStream::new(
        odf::metadata::DatasetVocabulary {
            event_time_column: "year".to_string(),
            ..Default::default()
        },
        odf::metadata::MergeStrategyUpsertStream {
...
async fn test_upsert_merge_to_empty_as_is() {
    test_upsert_merge(
        [],
        [
...
#[test_group::group(engine, ingest, datafusion)]
#[test_log::test(tokio::test)]
async fn test_upsert_merge_to_empty_inter_batch_upserts() {
    test_upsert_merge(
        [],
        [
            (Op::Append, 2020, "vancouver", 1),
            (Op::Append, 2020, "vancouver", 2),
            (Op::CorrectTo, 2020, "vancouver", 3),
            (Op::Append, 2020, "seattle", 2),
            (Op::Append, 2020, "kyiv", 3),
            (Op::Retract, 2020, "seattle", 2),
        ],
        [
            (Op::Append, 2020, "kyiv", 3),
            (Op::Append, 2020, "vancouver", 3),
        ],
    )
    .await;
}
...
#[test_group::group(engine, ingest, datafusion)]
#[test_log::test(tokio::test)]
async fn test_upsert_merge_unseen() {
    test_upsert_merge(
        [
            (Op::Append, 2020, "vancouver", 1),
            (Op::Append, 2020, "seattle", 2),
...
#[test_group::group(engine, ingest, datafusion)]
#[test_log::test(tokio::test)]
async fn test_upsert_merge_noop_upsert_ordered() {
    test_upsert_merge(
        [
            (Op::Append, 2020, "vancouver", 1),
            (Op::Append, 2020, "seattle", 2),
...
#[test_group::group(engine, ingest, datafusion)]
#[test_log::test(tokio::test)]
async fn test_upsert_merge_noop_upsert_unordered() {
    test_upsert_merge(
        [
            (Op::Append, 2020, "vancouver", 1),
            (Op::Append, 2020, "seattle", 2),
...
#[test_group::group(engine, ingest, datafusion)]
#[test_log::test(tokio::test)]
async fn test_upsert_merge_update_in_separate_batch() {
    test_upsert_merge(
        [
            (Op::Append, 2020, "vancouver", 1),
            (Op::Append, 2020, "seattle", 2),
        ...
        [
            (Op::Append, 2020, "vancouver", 2),
            (Op::CorrectTo, 2020, "kyiv", 4),
        ],
        [
            (Op::CorrectFrom, 2020, "kyiv", 3),
            (Op::CorrectTo, 2020, "kyiv", 4),
...
#[test_group::group(engine, ingest, datafusion)]
#[test_log::test(tokio::test)]
async fn test_upsert_merge_update_in_same_batch() {
    test_upsert_merge(
        [
            (Op::Append, 2020, "vancouver", 1),
            (Op::Append, 2020, "seattle", 2),
...
#[test_group::group(engine, ingest, datafusion)]
#[test_log::test(tokio::test)]
async fn test_upsert_merge_delete_in_separate_batch() {
    test_upsert_merge(
        [
            (Op::Append, 2020, "vancouver", 1),
            (Op::Append, 2020, "seattle", 2),
...
#[test_group::group(engine, ingest, datafusion)]
#[test_log::test(tokio::test)]
async fn test_upsert_merge_delete_in_same_batch() {
    test_upsert_merge(
        [
            (Op::Append, 2020, "vancouver", 1),
            (Op::Append, 2020, "seattle", 2),
