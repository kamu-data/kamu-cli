...
pub struct OutboxMessageRepositoryPostgres {
    transaction: TransactionRefT<sqlx::Postgres>,
}

#[component(pub)]
#[interface(dyn OutboxMessageRepository)]
impl OutboxMessageRepositoryPostgres {
...
impl OutboxMessageRepository for OutboxMessageRepositoryPostgres {
    async fn push_message(&self, message: NewOutboxMessage) -> Result<(), InternalError> {
        ...
        sqlx::query!(
            r#"
                INSERT INTO outbox_messages (message_type, producer_name, content_json, occurred_on)
                    VALUES ($1, $2, $3, $4)
            "#,
