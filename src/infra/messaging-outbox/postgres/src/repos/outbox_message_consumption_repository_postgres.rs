...
pub struct OutboxMessageConsumptionRepositoryPostgres {
    transaction: TransactionRefT<sqlx::Postgres>,
}

#[component(pub)]
#[interface(dyn OutboxMessageConsumptionRepository)]
impl OutboxMessageConsumptionRepositoryPostgres {
...
impl OutboxMessageConsumptionRepository for OutboxMessageConsumptionRepositoryPostgres {
