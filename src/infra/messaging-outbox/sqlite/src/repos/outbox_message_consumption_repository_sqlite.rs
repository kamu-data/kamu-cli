...
pub struct OutboxMessageConsumptionRepositorySqlite {
    transaction: TransactionRefT<sqlx::Sqlite>,
}

#[component(pub)]
#[interface(dyn OutboxMessageConsumptionRepository)]
impl OutboxMessageConsumptionRepositorySqlite {
...
impl OutboxMessageConsumptionRepository for OutboxMessageConsumptionRepositorySqlite {
