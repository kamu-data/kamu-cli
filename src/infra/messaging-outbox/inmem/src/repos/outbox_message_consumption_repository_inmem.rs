...
pub struct OutboxMessageConsumptionRepositoryInMemory {
...
impl OutboxMessageConsumptionRepositoryInMemory {
    pub fn new() -> Self {
        Self {
...
impl OutboxMessageConsumptionRepository for OutboxMessageConsumptionRepositoryInMemory {
