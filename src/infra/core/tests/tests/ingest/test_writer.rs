...
async fn test_data_writer_happy_path() {
    ...
    assert_data_eq(
        ...
        indoc!(
           ...
           +--------+----+----------------------+------------+------+------------+
           | 0      | 0  | 2010-01-01T12:00:00Z |            | A    | 1000       |
           | 1      | 0  | 2010-01-01T12:00:00Z |            | B    | 2000       |
           | 2      | 0  | 2010-01-01T12:00:00Z |            | C    | 3000       |
           +--------+----+----------------------+------------+------+------------+
           "#
        ),
    )
...
async fn test_data_writer_snapshot_orders_by_pk_and_operation_type() {
    ...
    assert_data_eq(
        ...
        indoc!(
            ...
            | 1      | 0  | 2010-01-01T12:00:00Z |            | B    | 2000       |
            | 2      | 0  | 2010-01-01T12:00:00Z |            | C    | 3000       |
            | 3      | 0  | 2010-01-01T12:00:00Z |            | D    | 4000       |
            +--------+----+----------------------+------------+------+------------+
            "#
        ),
    )
    ...
    assert_data_eq(
        ...
        indoc!(
            ...
            | offset | op | system_time          | event_time | city | population |
            +--------+----+----------------------+------------+------+------------+
            | 4      | 1  | 2010-01-02T12:00:00Z |            | A    | 1000       |
            | 5      | 2  | 2010-01-02T12:00:00Z |            | B    | 2000       |
            | 6      | 3  | 2010-01-02T12:00:00Z |            | B    | 4000       |
            | 7      | 2  | 2010-01-02T12:00:00Z |            | D    | 4000       |
            | 8      | 3  | 2010-01-02T12:00:00Z |            | D    | 5000       |
            +--------+----+----------------------+------------+------+------------+
            "#
        ),
    )
