...
use kamu_core::{GetBlockError, InsertBlockResult, InsertOpts, MetadataBlockRepository};
use opendatafabric::{MetadataBlock, MetadataEvent, Multihash, SetInfo};

/////////////////////////////////////////////////////////////////////////////////////////

pub async fn test_insert_block(repo: &dyn MetadataBlockRepository) {
    let (block, hash) = create_block();
...
pub fn create_block() -> (MetadataBlock, Multihash) {
