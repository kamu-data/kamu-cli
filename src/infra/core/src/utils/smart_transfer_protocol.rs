...
use kamu_core::{Dataset, DatasetPublicity, SyncError, SyncListener, SyncResult};
...
pub struct TransferOptions {
    ...
    pub visibility_for_created_dataset: DatasetPublicity,
}
...
impl Default for TransferOptions {
    fn default() -> Self {
        ...
        Self {
            ...
            visibility_for_created_dataset: DatasetPublicity::Private,
        }
    }
}
