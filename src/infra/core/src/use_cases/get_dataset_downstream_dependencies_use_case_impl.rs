    ...
    async fn execute(
        ...
        downstream_dependencies.extend(
            dataset_entries_resolution
                .unresolved_entries
                .into_iter()
                .map(DownstreamDependency::Unresolved),
        );
        ...
        for dataset_entry in dataset_entries_resolution.resolved_entries {
            ...
            if let Some(account) = maybe_account {
                ...
                downstream_dependencies.push(DownstreamDependency::resolved(
                    dataset_handle,
                    account.id.clone(),
                ...
                downstream_dependencies.push(DownstreamDependency::Unresolved(dataset_entry.id));
            }
        }
