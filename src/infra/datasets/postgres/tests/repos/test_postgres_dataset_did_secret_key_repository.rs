...
use kamu_datasets_postgres::{
    PostgresDatasetDidSecretKeyRepository,
    PostgresDatasetEntryRepository,
};
...
database_transactional_test!(
    ...
    harness = PostgresDatasetDidSecretKeyRepositoryHarness
);

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

struct PostgresDatasetDidSecretKeyRepositoryHarness {
    catalog: Catalog,
}

impl PostgresDatasetDidSecretKeyRepositoryHarness {
    pub fn new(pg_pool: PgPool) -> Self {
        ...
        catalog_builder.add::<PostgresDatasetDidSecretKeyRepository>();
