...
pub struct EventStoreInMemory<Proj: Projection, State: EventStoreState<Proj>> {
    state: Arc<Mutex<State>>,
    _proj: PhantomData<Proj>,
}

impl<Proj: Projection, State: EventStoreState<Proj>> EventStoreInMemory<Proj, State> {
    pub fn new() -> Self {
        Self {
...
impl<Proj: Projection, State: EventStoreState<Proj>> EventStore<Proj>
    for EventStoreInMemory<Proj, State>
{
