                ...
                schema: Some(DataSchema {
                    fields: vec![
                        ...
                        DataField {
                            ...
                            r#type: DataType::Timestamp(DataTypeTimestamp {
                        ...
                        DataField {
                            name: "match_time".into(),
                            r#type: DataType::Option(DataTypeOption {
                                inner: Box::new(DataType::Timestamp(DataTypeTimestamp {
                                    unit: TimeUnit::Millisecond,
                                    timezone: Some("UTC".into()),
                                })),
                            }),
                        ...
                        DataField {
                            name: "match_id".into(),
                            r#type: DataType::Option(DataTypeOption {
                                inner: Box::new(DataType::Int(DataTypeInt {
                                    bit_width: 64,
                                    signed: true,
                                })),
                            }),
