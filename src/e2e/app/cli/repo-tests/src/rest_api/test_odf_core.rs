...
pub async fn test_odf_info_st(kamu_api_server_client: KamuApiServerClient) {
    test_odf_info(kamu_api_server_client, false).await;
}

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

pub async fn test_odf_info_mt(kamu_api_server_client: KamuApiServerClient) {
    test_odf_info(kamu_api_server_client, true).await;
}
