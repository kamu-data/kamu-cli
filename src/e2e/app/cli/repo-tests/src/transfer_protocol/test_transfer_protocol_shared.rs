...
pub async fn test_push_pull_sequence(
    ...
    let kamu_api_server_dataset_endpoint = kamu_api_server_client
        .dataset()
        .get_endpoint(&dataset_alias, transfer_protocol);
...
pub async fn test_force_push_pull(
    mut kamu_api_server_client: KamuApiServerClient,
    transfer_protocol: TransferProtocol,
) {
    let dataset_alias = DatasetAlias::new(
...
pub async fn test_push_pull_add_alias(
    mut kamu_api_server_client: KamuApiServerClient,
    transfer_protocol: TransferProtocol,
) {
    let dataset_alias = DatasetAlias::new(
...
pub async fn test_push_pull_all(
    mut kamu_api_server_client: KamuApiServerClient,
    transfer_protocol: TransferProtocol,
) {
    ...
    let kamu_api_server_root_dataset_endpoint = kamu_api_server_client
        .dataset()
        .get_endpoint(&root_dataset_alias, transfer_protocol);
    ...
    let kamu_api_server_derivative_dataset_endpoint = kamu_api_server_client
        .dataset()
        .get_endpoint(&derivative_dataset_alias, transfer_protocol);
...
pub async fn test_push_pull_recursive(
    mut kamu_api_server_client: KamuApiServerClient,
    transfer_protocol: TransferProtocol,
) {
    let root_dataset_alias = DatasetAlias::new(
...
pub async fn test_push_visibility(
    mut kamu_api_server_client: KamuApiServerClient,
    transfer_protocol: TransferProtocol,
) {
    let dataset_alias = DatasetAlias::new(
...
pub async fn test_push_from_registered_repo(
    mut kamu_api_server_client: KamuApiServerClient,
    transfer_protocol: TransferProtocol,
) {
    let dataset_alias = DatasetAlias::new(
