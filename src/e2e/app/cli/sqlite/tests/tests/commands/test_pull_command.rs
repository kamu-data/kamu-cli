...
// Needs secrets encryption configured: dataset env vars are only resolved when
// the feature is enabled.
kamu_cli_execute_command_e2e_test!(
    storage = sqlite,
    fixture = kamu_cli_e2e_repo_tests::commands::test_pull_env_var_from_labelled_variable_set_st,
