...
/// NOTE: 1 millisecond for stable output within tests
///
...
pub const DATASET_ROOT_PLAYER_SCORES_INGEST_DATA_NDJSON_CHUNK_1: &str = indoc::indoc!(
    ...
    {"match_time": "2000-01-01 00:00:00.000001", "match_id": 1, "player_id": "Bob", "score": 80}
    "#
);
...
pub const DATASET_ROOT_PLAYER_SCORES_INGEST_DATA_NDJSON_CHUNK_2: &str = indoc::indoc!(
    ...
    {"match_time": "2000-01-02 00:00:00.000001", "match_id": 2, "player_id": "Charlie", "score": 90}
    "#
);
