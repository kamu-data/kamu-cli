...
impl ScalarUDFImpl for AssertNotNull {
    ...
    fn return_type(&self, _args: &[DataType]) -> datafusion::error::Result<DataType> {
        datafusion::common::internal_err!("return_field_from_args should be called instead")
    }
    ...
    fn invoke_with_args(
        ...
        let arr = match &args.args[0] {
            ...
            _ => return datafusion::common::exec_err!("assert_not_null expects a column argument"),
        };
