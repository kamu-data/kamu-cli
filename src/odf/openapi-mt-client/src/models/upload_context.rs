...
impl UploadContext {
    pub fn new(fields: Vec<Vec<serde_json::Value>>, headers: Vec<Vec<serde_json::Value>>, method: String, upload_token: String, upload_url: String, use_multipart: bool) -> UploadContext {
        UploadContext {
            fields,
            headers,
            method,
