...
pub struct InvalidRequestOneOf1 {
...
impl InvalidRequestOneOf1 {
    pub fn new(message: String, kind: Kind) -> InvalidRequestOneOf1 {
        InvalidRequestOneOf1 { message, kind }
    }
}
///
...
pub enum Kind {
    ...
    InvalidRequestColonColonSubQueriesHash,
}

impl Default for Kind {
    fn default() -> Kind {
        Self::InvalidRequestColonColonSubQueriesHash
    }
}
