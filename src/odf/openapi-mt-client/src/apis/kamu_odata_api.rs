...
pub trait KamuOdataApi: Send + Sync {
    ...
    ///
    /// 
    async fn odata_collection_handler_mt(&self,  params: OdataCollectionHandlerMtParams ) -> Result<String, Error<OdataCollectionHandlerMtError>>;

    /// GET /odata/{account_name}/$metadata
    ///
    /// 
    async fn odata_metadata_handler_mt(&self,  params: OdataMetadataHandlerMtParams ) -> Result<String, Error<OdataMetadataHandlerMtError>>;

    /// GET /odata/{account_name}
    ///
    /// 
    async fn odata_service_handler_mt(&self,  params: OdataServiceHandlerMtParams ) -> Result<String, Error<OdataServiceHandlerMtError>>;
}
...
impl KamuOdataApi for KamuOdataApiClient {
    async fn odata_collection_handler_mt(&self,  params: OdataCollectionHandlerMtParams ) -> Result<String, Error<OdataCollectionHandlerMtError>> {
        ...
        let local_var_uri_str = format!("{}/odata/{account_name}/{dataset_name}", local_var_configuration.base_path, account_name=crate::apis::urlencode(account_name), dataset_name=crate::apis::urlencode(dataset_name));
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<OdataCollectionHandlerMtError> = serde_json::from_str(&local_var_content).ok();
    ...
    async fn odata_metadata_handler_mt(&self,  params: OdataMetadataHandlerMtParams ) -> Result<String, Error<OdataMetadataHandlerMtError>> {
        ...
        let OdataMetadataHandlerMtParams {
            account_name,
        } = params;
        ...
        let local_var_uri_str = format!("{}/odata/{account_name}/$metadata", local_var_configuration.base_path, account_name=crate::apis::urlencode(account_name));
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<OdataMetadataHandlerMtError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn odata_service_handler_mt(&self,  params: OdataServiceHandlerMtParams ) -> Result<String, Error<OdataServiceHandlerMtError>> {
        ...
        let OdataServiceHandlerMtParams {
            account_name,
        } = params;
        ...
        let local_var_uri_str = format!("{}/odata/{account_name}", local_var_configuration.base_path, account_name=crate::apis::urlencode(account_name));
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<OdataServiceHandlerMtError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
