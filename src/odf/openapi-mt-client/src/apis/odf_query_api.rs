...
pub trait OdfQueryApi: Send + Sync {
    ...
    ///
    /// 
    async fn dataset_metadata_handler(&self,  params: DatasetMetadataHandlerParams ) -> Result<models::DatasetMetadataResponse, Error<DatasetMetadataHandlerError>>;

    /// GET /{account_name}/{dataset_name}/tail
    ///
    /// 
    async fn dataset_tail_handler(&self,  params: DatasetTailHandlerParams ) -> Result<models::DatasetTailResponse, Error<DatasetTailHandlerError>>;
    ...
    async fn query_handler(&self,  params: QueryHandlerParams ) -> Result<models::QueryResponse, Error<QueryHandlerError>>;
    ...
    async fn query_handler_post(&self,  params: QueryHandlerPostParams ) -> Result<models::QueryResponse, Error<QueryHandlerPostError>>;
    ...
    async fn verify_handler(&self,  params: VerifyHandlerParams ) -> Result<models::VerifyResponse, Error<VerifyHandlerError>>;
}
...
impl OdfQueryApi for OdfQueryApiClient {
    async fn dataset_metadata_handler(&self,  params: DatasetMetadataHandlerParams ) -> Result<models::DatasetMetadataResponse, Error<DatasetMetadataHandlerError>> {
        ...
        let local_var_uri_str = format!("{}/{account_name}/{dataset_name}/metadata", local_var_configuration.base_path, account_name=crate::apis::urlencode(account_name), dataset_name=crate::apis::urlencode(dataset_name));
        ...
        if let Some(ref local_var_str) = schema_format {
            local_var_req_builder = local_var_req_builder.query(&[("schemaFormat", &local_var_str.to_string())]);
        }
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::DatasetMetadataResponse`"))),
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DatasetMetadataResponse`")))),
            }
        } else {
            let local_var_entity: Option<DatasetMetadataHandlerError> = serde_json::from_str(&local_var_content).ok();
    ...
    async fn dataset_tail_handler(&self,  params: DatasetTailHandlerParams ) -> Result<models::DatasetTailResponse, Error<DatasetTailHandlerError>> {
        ...
        let local_var_uri_str = format!("{}/{account_name}/{dataset_name}/tail", local_var_configuration.base_path, account_name=crate::apis::urlencode(account_name), dataset_name=crate::apis::urlencode(dataset_name));
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if let Some(ref local_var_str) = data_format {
            local_var_req_builder = local_var_req_builder.query(&[("dataFormat", &local_var_str.to_string())]);
        }
        local_var_req_builder = local_var_req_builder.query(&[("schemaFormat", &schema_format.to_string())]);
        if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
            local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
        }
        if let Some(ref local_var_token) = local_var_configuration.bearer_access_token {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ContentType::Json => serde_json::from_str(&local_var_content).map_err(Error::from),
                ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::DatasetTailResponse`"))),
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DatasetTailResponse`")))),
            }
        } else {
            let local_var_entity: Option<DatasetTailHandlerError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn query_handler(&self,  params: QueryHandlerParams ) -> Result<models::QueryResponse, Error<QueryHandlerError>> {
        ...
        if let Some(ref local_var_str) = query_dialect {
            local_var_req_builder = local_var_req_builder.query(&[("queryDialect", &local_var_str.to_string())]);
        }
        if let Some(ref local_var_str) = skip {
            local_var_req_builder = local_var_req_builder.query(&[("skip", &local_var_str.to_string())]);
        }
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::QueryResponse`")))),
            }
        } else {
            let local_var_entity: Option<QueryHandlerError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn query_handler_post(&self,  params: QueryHandlerPostParams ) -> Result<models::QueryResponse, Error<QueryHandlerPostError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<QueryHandlerPostError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn verify_handler(&self,  params: VerifyHandlerParams ) -> Result<models::VerifyResponse, Error<VerifyHandlerError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::VerifyResponse`")))),
            }
        } else {
            let local_var_entity: Option<VerifyHandlerError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
