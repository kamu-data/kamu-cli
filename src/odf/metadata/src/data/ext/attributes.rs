...
use crate::data::{ExtraAttribute, IntoExtraAttribute};
...
impl ExtraAttribute for AttrDescription {
...
impl ExtraAttribute for AttrType {
...
impl IntoExtraAttribute for DataTypeExt {
...
impl ExtraAttribute for AttrLinkedObjects {
...
impl IntoExtraAttribute for LinkedObjectsSummary {
...
impl ExtraAttribute for AttrArchetype {
...
impl IntoExtraAttribute for DatasetArchetype {
...
mod test {
    ...
    use super::*;
    use crate::data::ExtraAttributes;
    ...
    fn test_attr_type_core() {
        let attr = AttrType::new(DataTypeExt::core(crate::data::DataType::string()));
