...
impl From<odf::metadata::DataType> for DataType {
    fn from(v: odf::metadata::DataType) -> Self {
        match v {
            ...
            odf::metadata::DataType::Float16(v) => Self::Float16(v.into()),
            odf::metadata::DataType::Float32(v) => Self::Float32(v.into()),
            odf::metadata::DataType::Float64(v) => Self::Float64(v.into()),
            odf::metadata::DataType::Int8(v) => Self::Int8(v.into()),
            odf::metadata::DataType::Int16(v) => Self::Int16(v.into()),
            odf::metadata::DataType::Int32(v) => Self::Int32(v.into()),
            odf::metadata::DataType::Int64(v) => Self::Int64(v.into()),
            odf::metadata::DataType::UInt8(v) => Self::UInt8(v.into()),
            odf::metadata::DataType::UInt16(v) => Self::UInt16(v.into()),
            odf::metadata::DataType::UInt32(v) => Self::UInt32(v.into()),
            odf::metadata::DataType::UInt64(v) => Self::UInt64(v.into()),
...
impl From<odf::metadata::DataTypeFloat16> for DataTypeFloat16 {
    fn from(v: odf::metadata::DataTypeFloat16) -> Self {
        Self { _dummy: None }
    }
}
...
impl From<odf::metadata::DataTypeFloat32> for DataTypeFloat32 {
    fn from(v: odf::metadata::DataTypeFloat32) -> Self {
        Self { _dummy: None }
    }
}
...
impl From<odf::metadata::DataTypeFloat64> for DataTypeFloat64 {
    fn from(v: odf::metadata::DataTypeFloat64) -> Self {
        Self { _dummy: None }
    }
}
...
impl From<odf::metadata::DataTypeInt16> for DataTypeInt16 {
    fn from(v: odf::metadata::DataTypeInt16) -> Self {
        Self { _dummy: None }
    }
}
...
impl From<odf::metadata::DataTypeInt32> for DataTypeInt32 {
    fn from(v: odf::metadata::DataTypeInt32) -> Self {
        Self { _dummy: None }
    }
}
...
impl From<odf::metadata::DataTypeInt64> for DataTypeInt64 {
    fn from(v: odf::metadata::DataTypeInt64) -> Self {
        Self { _dummy: None }
    }
}
...
impl From<odf::metadata::DataTypeInt8> for DataTypeInt8 {
    fn from(v: odf::metadata::DataTypeInt8) -> Self {
        Self { _dummy: None }
    }
}
...
impl From<odf::metadata::DataTypeUInt16> for DataTypeUInt16 {
    fn from(v: odf::metadata::DataTypeUInt16) -> Self {
        Self { _dummy: None }
    }
}
...
impl From<odf::metadata::DataTypeUInt32> for DataTypeUInt32 {
    fn from(v: odf::metadata::DataTypeUInt32) -> Self {
        Self { _dummy: None }
    }
}
...
impl From<odf::metadata::DataTypeUInt64> for DataTypeUInt64 {
    fn from(v: odf::metadata::DataTypeUInt64) -> Self {
        Self { _dummy: None }
    }
}
...
impl From<odf::metadata::DataTypeUInt8> for DataTypeUInt8 {
    fn from(v: odf::metadata::DataTypeUInt8) -> Self {
        Self { _dummy: None }
    }
}
