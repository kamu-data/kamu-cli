...
impl GraphQLMoleculeV1Harness {
    ...
    pub async fn new(
        ...
        let base_catalog = dill::CatalogBuilder::new_chained(base_gql_harness.catalog())
            ...
            .add::<kamu_molecule_services::CreateMoleculeProjectUseCaseImpl>()
            .add::<kamu_molecule_services::FindMoleculeProjectUseCaseImpl>()
            .add::<kamu_molecule_services::ViewMoleculeProjectsUseCaseImpl>()
