...
#[dill::component]
#[dill::interface(dyn fs::FlowBatchingConditionQuery)]
pub struct FlowBatchingConditionQueryImpl {
...
impl fs::FlowBatchingConditionQuery for FlowBatchingConditionQueryImpl {
