...
use crate::cynic_api::operations::supported_resource_types;
...
impl From<fragments::ResourceStatus> for domain::ResourceStatus {
    fn from(value: fragments::ResourceStatus) -> Self {
        Self {
            ...
            reconciled_generation: value.reconciled_generation.map(Into::into),
...
impl From<fragments::ResourceRenderManifestResult>
    for kamu_resources_facade::RenderResourceManifestResult
{
