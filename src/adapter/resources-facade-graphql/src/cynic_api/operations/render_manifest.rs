...
use kamu_resources_facade::{ResourceManifestFormat as DomainFormat, SpecViewOpts};
...
use crate::cynic_api::inputs::{ResourceRefInput, SpecViewOptsInput, resource_ref_inputs};
