...
use kamu_resources_facade::ApplyManifestBatchRequest;

use crate::cynic_api::inputs::ApplyManifestInput;
use crate::cynic_api::operations::apply::ResourceApplyOutcome;
