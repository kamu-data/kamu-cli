...
fn test_valid_patterns() {
    ...
    let res = Grammar::match_dataset_alias_pattern(param);
    ...
    // Glob wildcard
    let valid_param = "%";
    let res = Grammar::match_dataset_alias_pattern(valid_param);
...
fn test_invalid_patterns() {
    ...
    let res = Grammar::match_dataset_alias_pattern(&invalid_param);
