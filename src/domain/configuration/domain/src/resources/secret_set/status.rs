...
pub type SecretSetStatus = ResourceStatus;
    ...
    for SecretSetStatusProjector
{
    ...
    fn on_reconciliation_succeeded(
        ...
        _success: SecretSetReconcileSuccess,
    ) {
    }

    fn on_reconciliation_failed(_status: &mut Self::Status, _details: SecretSetFailureDetails) {}
}
