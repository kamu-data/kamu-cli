...
pub const RESOURCE_CONDITION_RECONCILING_SCHEMA_DOC: &str =
    include_str!("../../../../../schemas/resource/v1alpha1/conditions/Reconciling.json");

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

pub struct ReconcilingCondition;

impl ResourceValidateSchemaValue for ReconcilingCondition {
