...
pub const RESOURCE_CONDITION_READY_SCHEMA_DOC: &str =
    include_str!("../../../../../schemas/resource/v1alpha1/conditions/Ready.json");

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

pub struct ReadyCondition;

impl ResourceValidateSchemaValue for ReadyCondition {
